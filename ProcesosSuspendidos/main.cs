...
namespace SimuladorProcesoPorLotes
{
    public partial class main : Form
    {
        ...
        string[] opes = { "+", "-", "/", "%", "*" };
        int rest;
        String auxFile= "F:\\Universidadd\\Universidad\\6 sem\\Sem sistemas operativos\\Programa 8\\Auxiliar.txt";
        String suspendedFile = "F:\\Universidadd\\Universidad\\6 sem\\Sem sistemas operativos\\Programa 8\\Suspendidos.txt";
        ...
        private void cargaTabla()
        {
            ...
            id.UseItemStyleForSubItems = false;
            listView1.Items[1] = id;
            id = new ListViewItem("3");
            for (int i = 0; i < 6; i++)
            {
                id.SubItems.Add("");
            }
            ...
            id.UseItemStyleForSubItems = false;
            listView2.Items[1] = id;
            listView1.Items[0].SubItems[6].Text = "SO";
            listView2.Items[0].SubItems[6].Text = "SO";
            listView1.Items[1].SubItems[6].Text = "SO";
            listView2.Items[1].SubItems[6].Text = "SO";
        ...
        public void agregaProceso(int i)
        {
            ...
            int rDos = r.Next(1, 9);
            int rOpe = r.Next(0, 4);
            int rTime = r.Next(6, 28);
            int rSize = r.Next(6, 28);
